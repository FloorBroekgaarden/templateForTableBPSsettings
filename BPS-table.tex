...
\section{COMPAS}
Table~\ref{tab:COMPAS} shows an example of a table summarizing the binary population synthesis settings for a simulation using the code {\sc{COMPAS}}. This table is used in \citet{2021arXiv210302608B}. You can easily remove the cyan stars in front of some of the rows. 
